...
DROP TABLE IF EXISTS ActivityRecurrenceMonthDay;
DROP TABLE IF EXISTS ActivityRecurrenceDay;
...
-- =============================================
CREATE TABLE ActivityRecurrenceDay (
...
-- =============================================
CREATE TABLE ActivityRecurrenceMonthDay (
    `activityId`           BIGINT NOT NULL,
...
-- =============================================
-- 활동 대폭 추가
INSERT INTO Activity (`activityId`, `orgId`, `creatorId`, `activityCategory`, `activityType`, `activityState`, `title`, `description`, `location`, `maxMembers`, `startAt`, `endAt`, `recurrence`, `pointAmount`) VALUES
...
INSERT INTO ActivityRecurrenceDay (`activityId`, `recurrenceDay`) VALUES
(1, 'SATURDAY'),
(2, 'SUNDAY'),
(5, 'THURSDAY');

-- 유저1 활동 신청
INSERT INTO ActivityApply (`activityId`, `userId`, `pointEarned`) VALUES
(1, 2, 100), (2, 2, 50), (4, 2, 100), (5, 2, 50);

-- 캘린더 데이터 (유저1: userId=2 중심)
INSERT INTO Calendar (`userId`, `activityId`, `calendarType`, `title`, `startDateTime`, `endDateTime`, `memo`) VALUES
-- 활동 연동 일정
(2, 1, 'CHURCH', '도시락 배달 봉사', '2026-05-02 09:00:00', '2026-05-02 12:00:00', '토요일 오전 봉사 필수!'),
(2, 2, 'CHURCH', '배드민턴 모임', '2026-05-03 15:00:00', '2026-05-03 17:00:00', '라켓 챙기기'),
(2, 5, 'CHURCH', '찬양대 연습', '2026-05-07 10:00:00', '2026-05-07 12:00:00', '가운 지참'),
-- 개인 일정
(2, NULL, 'PERSONAL', '아침 기도회', '2026-04-20 06:00:00', '2026-04-20 07:00:00', '새벽을 깨우는 기도'),
(2, NULL, 'PERSONAL', '손주 돌보기', '2026-04-21 14:00:00', '2026-04-21 18:00:00', '맛있는 간식 사가기'),
(2, NULL, 'PERSONAL', '성경 일독 도전', '2026-04-22 21:00:00', '2026-04-22 22:00:00', '시편 읽기 시작'),
(2, NULL, 'PERSONAL', '건강검진 예약', '2026-04-25 10:00:00', '2026-04-25 11:00:00', '금식 확인'),
-- 목사1 일정
(3, NULL, 'PERSONAL', '금요 철야 예배 인도', '2026-04-24 21:00:00', '2026-04-24 23:00:00', '설교 원고 준비'),
(3, 3, 'CHURCH', '여름성경학교 기획', '2026-05-10 14:00:00', '2026-05-10 16:00:00', '예산 확인');
