...
-- SEED DATA
-- =============================================
INSERT INTO User (`userId`, `orgId`, `name`, `birthDate`, `phone`, `password`, `role`, `donationRate`, `pointSum`) VALUES
...
INSERT INTO Account (`accountId`, `userId`, `bankName`, `accountNumber`, `balance`, `isHana`, `isDefault`, `isSavings`) VALUES
...
UPDATE User SET `defaultAccountId` = 1 WHERE `userId` = 1;
UPDATE User SET `defaultAccountId` = 2 WHERE `userId` = 2;
UPDATE User SET `defaultAccountId` = 3 WHERE `userId` = 3;

INSERT INTO PointPolicy (`pointType`, `amount`, `description`) VALUES
...
-- 풍성한 포인트 이력
INSERT INTO Point (`userId`, `pointType`, `amount`, `info`) VALUES
(2, 'OFFERING_RECURRING', 500, '정기헌금: 십일조 등록'),
(2, 'ACTIVITY_VOLUNTEER', 100, '봉사활동: 독거노인 도시락 배달'),
(2, 'ACTIVITY_VOLUNTEER', 100, '봉사활동: 병원 안내 봉사'),
(2, 'SAVINGS_JOIN', 500, '적금가입: 하나 하나님의 적금'),
(2, 'OFFERING_ONCE', 150, '헌금: 감사헌금 포인트 적립'),
(2, 'ACTIVITY_CHURCH', 50, '교회활동: 배드민턴 소모임'),
(2, 'OFFERING_ONCE', 1000, '이벤트: 하나은행 첫 헌금 감사 포인트'),
(3, 'ACTIVITY_CHURCH', 50, '교회활동: 성경 공부 소모임'),
(3, 'OFFERING_RECURRING', 500, '정기헌금: 선교헌금 등록'),
(1, 'SAVINGS_JOIN', 5000, '관리자 이벤트 포인트');
