...
DROP TABLE IF EXISTS PrayerSavings;
...
-- 2. PrayerSavings
-- =============================================
CREATE TABLE PrayerSavings (
    `prayerSavingsId` INT UNSIGNED NOT NULL AUTO_INCREMENT,
    `gift`              INT UNSIGNED NOT NULL,
...
-- SEED DATA
-- =============================================
INSERT INTO Gift (`giftId`, `senderId`, `receiverId`, `giftReceiverType`, `fromAccountId`, `toSavingsAccountId`, `amount`, `cumulativeTotal`, `savingsProductName`, `interestRate`) VALUES
...
INSERT INTO PrayerSavings (`gift`, `prayerContent`, `startDate`, `dDay`) VALUES
(1, '매달 쌓이는 적금처럼 당신을 향한 축복도 쌓여가길 기도합니다.', '2026-04-01', 19),
(1, '지치고 힘들 때마다 이 적금이 작은 위로가 되길 바랍니다.', '2026-04-01', 19),
(1, '오늘도 주님의 은혜 안에서 평안한 하루 보내세요.', '2026-04-01', 19),
(2, '우리 아이가 하나님의 사랑 안에서 지혜롭게 자라기를 기도합니다.', '2026-04-10', 9),
(2, '건강하게 자라주어 고맙다. 항상 응원한다.', '2026-04-10', 9),
(3, '우리 성도님의 삶에 주님의 축복이 가득하길 소망합니다.', '2026-04-15', 4);
